...
export const onlyAuthor: Author[] = [
    {
        id: "1",
        name: "Bap Truong",
        value: "Bap Truong",
...
export const onlyCategories: Categories[] = [
    {
        name: "Technology",
    },
    {
...
export const fetchPostList = (): Promise<Post[]> => {
...
export const fetchAuthorList = (): Promise<Author[]> => {
    return new Promise((resolve) => {
        setTimeout(() => {
            resolve(onlyAuthor);
        }, 1200);
...
export const fetchCategoriesList = (): Promise<Categories[]> => {
    return new Promise((resolve) => {
        setTimeout(() => {
